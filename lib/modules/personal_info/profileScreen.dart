      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text('My Posts',
                style: TextStyle(fontFamily: 'DMSans',fontWeight: FontWeight.bold, fontSize: 18)),
            Flexible(
              fit: FlexFit.loose,
            ...
            children: [
                          ...
                          GestureDetector(
                            ...
                            onTap: () async {
                              final datePick = await showDatePicker(
                                context: context,
                                initialDate: new DateTime.now().subtract(
                                    Duration(days: 1)),
                              ...
                              if (datePick != null && datePick != birthDate) {
                                setState(() {
                                  ...
                                  birthDateInString =
                                  "${birthDate
                                      ?.day}/${birthDate?.month}/${birthDate?.year}";
                                });
                              }
                            },
              ...
              Flexible(
                child: ElevatedButton(
                    ...
                    child: Text('Add pet',style: TextStyle(fontFamily: 'DMSans'),)),
              ),
            ],
          ),
        ),
